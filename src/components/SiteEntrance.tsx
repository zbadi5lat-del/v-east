        ...
        <div className="site-entry__ocean">
          <svg className="site-entry__ocean-svg" viewBox="0 0 1440 560" preserveAspectRatio="none" focusable="false">
            <defs>
              ...
              <filter id="veast-water-organic" x="-4%" y="-8%" width="108%" height="116%" colorInterpolationFilters="sRGB">
                <feTurbulence type="fractalNoise" baseFrequency="0.006 0.032" numOctaves="2" seed="17" result="waterNoise" />
                <feDisplacementMap in="SourceGraphic" in2="waterNoise" scale="8" xChannelSelector="R" yChannelSelector="B" />
              </filter>
              <filter id="veast-foam-organic" x="-3%" y="-10%" width="106%" height="120%" colorInterpolationFilters="sRGB">
                <feTurbulence type="fractalNoise" baseFrequency="0.012 0.075" numOctaves="2" seed="29" result="foamNoise" />
                <feDisplacementMap in="SourceGraphic" in2="foamNoise" scale="6" xChannelSelector="R" yChannelSelector="G" />
              </filter>
            </defs>
