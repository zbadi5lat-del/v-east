...
check('finite-cinematic-entry', css.includes('Ultra-smooth compositor pass') && css.includes('.site-entry { animation-duration: 2600ms; }') && !/animation\s*:[^;]*infinite/i.test(css), 'Cinematic entry remains finite and bounded.');
check('shoreward-backwash-cycle', entrance.includes('site-entry__shore-wet') && entrance.includes('site-entry__backwash') && css.includes('.site-entry__ocean-svg { animation: siteEntryOceanSurge 2100ms') && css.includes('@keyframes siteEntryOceanSurge') && css.includes('@keyframes siteEntryWetSand') && css.includes('@keyframes siteEntryBackwash') && !css.includes('siteEntryOceanDrift 2100ms'), 'Primary water motion is shoreward/backwash rather than lateral sliding, with wet-sand interaction.');
