...
check('finite-cinematic-entry', css.includes('siteEntryExit 3200ms') && !/animation\s*:[^;]*infinite/i.test(css), 'Cinematic entry remains finite and bounded.');
check('shoreward-backwash-cycle', entrance.includes('site-entry__shore-wet') && entrance.includes('site-entry__backwash') && css.includes('siteEntryOceanSurge 2580ms') && css.includes('@keyframes siteEntryOceanSurge') && css.includes('@keyframes siteEntryWetSand') && css.includes('@keyframes siteEntryBackwash') && !css.includes('siteEntryOceanDrift 2580ms'), 'Primary water motion is shoreward/backwash rather than lateral sliding, with wet-sand interaction.');
