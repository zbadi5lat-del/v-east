...
check('finite-cinematic-entry', css.includes('Ultra-smooth compositor pass') && css.includes('Snappy cadence final pass') && css.includes('.site-entry { animation-duration: 2200ms; }') && !/animation\s*:[^;]*infinite/i.test(css), 'Cinematic entry remains finite and bounded.');
check('shoreward-backwash-cycle', entrance.includes('site-entry__shore-wet') && entrance.includes('site-entry__backwash') && css.includes('.site-entry__ocean-svg { animation: siteEntryOceanSurge 1750ms') && css.includes('@keyframes siteEntryOceanSurge') && css.includes('@keyframes siteEntryWetSand') && css.includes('@keyframes siteEntryBackwash') && !css.includes('siteEntryOceanDrift 1750ms'), 'Primary water motion is shoreward/backwash rather than lateral sliding, with wet-sand interaction.');
...
check('smooth-motion-pass', css.includes('Smooth Motion / high-FPS performance pass') && css.includes('Ultra-smooth compositor pass') && css.includes('.site-entry { animation-duration: 2200ms; }') && css.includes('.site-entry__ocean-svg { animation: siteEntryOceanSurge 1750ms') && css.includes('.site-entry__water-surface,') && css.includes('filter: none !important;') && hero.includes('Math.exp(-18 * dt)'), 'High-FPS pass shortens cadence, removes realtime ocean filters, and uses frame-rate-independent hero interpolation.');
