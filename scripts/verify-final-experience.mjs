...
check('pdf-popup-inert', floating.includes('aria-hidden={!resourcesOpen}') && floating.includes('inert={!resourcesOpen}') && floating.includes("event.key==='Escape'"), 'Closed PDF panel is inert/hidden and Escape-close is implemented.');
